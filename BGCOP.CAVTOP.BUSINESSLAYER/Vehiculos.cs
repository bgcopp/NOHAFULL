...
namespace BGCOP.CAVTOP.BUSINESSLAYER
{
	public class Vehiculos
	{
		...
		{
			TVehiculo tVehiculo = (new masterDBACEntities()).TVehiculo.FirstOrDefault<TVehiculo>((TVehiculo c) => c.Placa == placa);
			return tVehiculo;
		}
		...
		public string RandomString(int size, bool lowerCase)
		{
			...
			str = (!lowerCase ? stringBuilder.ToString() : stringBuilder.ToString().ToLower());
			return str;
		}
	}
}