...
{
	public class frmMarcacionesEmpleados : Form
	{
		...
		public frmMarcacionesEmpleados()
		{
		...
		private void frmMarcacionesEmpleados_Load(object sender, EventArgs e)
		{
			this.tEmpleadoTableAdapter.Fill(this.masterDBACDataSet.TEmpleado);
			this.tMarcacionTableAdapter.FillByEmpleados(this.masterDBACDataSet.TMarcacion);
		}

		private void InitializeComponent()
		{
			this.components = new System.ComponentModel.Container();
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmMarcacionesEmpleados));
			...
			this.label1.Text = "Reportes de Marcaciones de Empleados";
			this.button1.Anchor = AnchorStyles.Top | AnchorStyles.Right;
			this.button1.BackgroundImage = Resources.File_Excel_icon;
			this.button1.BackgroundImageLayout = ImageLayout.Stretch;
			this.button1.FlatStyle = FlatStyle.Flat;
			this.button1.Location = new Point(759, 12);
			...
			this.tMarcacionBindingNavigator.Location = new Point(0, 374);
			...
			this.tMarcacionBindingNavigator.Size = new System.Drawing.Size(817, 25);
			this.tMarcacionBindingNavigator.TabIndex = 3;
			...
			this.radGridView1.Location = new Point(9, 74);
			...
			gridViewComboBoxColumn.DisplayMember = "nombre";
			gridViewComboBoxColumn.FieldName = "idEmpleado";
			gridViewComboBoxColumn.FormatString = "";
			gridViewComboBoxColumn.HeaderText = "Empleado";
			...
			GridViewDataColumn[] gridViewDataColumnArray = new GridViewDataColumn[] { gridViewDecimalColumn, gridViewTextBoxColumn, gridViewDateTimeColumn, gridViewTextBoxColumn1, gridViewDecimalColumn1, gridViewDecimalColumn2, gridViewComboBoxColumn, gridViewDecimalColumn3 };
			...
			this.radGridView1.Size = new System.Drawing.Size(796, 297);
			...
			base.ClientSize = new System.Drawing.Size(817, 399);
			base.Controls.Add(this.radGridView1);
			base.Controls.Add(this.tMarcacionBindingNavigator);
			base.Controls.Add(this.panel1);
			base.Name = "frmMarcacionesEmpleados";
			this.Text = "frmMarcacionesEmpleados";
			base.Load += new EventHandler(this.frmMarcacionesEmpleados_Load);
