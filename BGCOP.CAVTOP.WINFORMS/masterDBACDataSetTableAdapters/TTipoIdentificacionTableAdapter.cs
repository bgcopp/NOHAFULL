...
namespace BGCOP.CAVTOP.WINFORMS.masterDBACDataSetTableAdapters
{
	...
	[ToolboxItem(true)]
	public class TTipoIdentificacionTableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public TTipoIdentificacionTableAdapter()
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Delete(int Original_idTipoIdentificacion, string Original_descripcionIdentificacion, DateTime? Original_fechaUltimaGestion, int? Original_usuarioUltimaGestion)
		{
			int num;
			this.Adapter.DeleteCommand.Parameters[0].Value = Original_idTipoIdentificacion;
			if (Original_descripcionIdentificacion != null)
			{
				this.Adapter.DeleteCommand.Parameters[1].Value = 0;
				this.Adapter.DeleteCommand.Parameters[2].Value = Original_descripcionIdentificacion;
			}
			else
			{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Fill(masterDBACDataSet.TTipoIdentificacionDataTable dataTable)
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual masterDBACDataSet.TTipoIdentificacionDataTable GetData()
		{
			this.Adapter.SelectCommand = this.CommandCollection[0];
			masterDBACDataSet.TTipoIdentificacionDataTable tTipoIdentificacionDataTable = new masterDBACDataSet.TTipoIdentificacionDataTable();
			this.Adapter.Fill(tTipoIdentificacionDataTable);
		...
		private void InitAdapter()
		{
			...
			{
				SourceTable = "Table",
				DataSetTable = "TTipoIdentificacion"
			};
			dataTableMapping.ColumnMappings.Add("idTipoIdentificacion", "idTipoIdentificacion");
			dataTableMapping.ColumnMappings.Add("descripcionIdentificacion", "descripcionIdentificacion");
			...
			this._adapter.DeleteCommand = new SqlCommand()
			{
				...
				CommandText = "DELETE FROM [dbo].[TTipoIdentificacion] WHERE (([idTipoIdentificacion] = @Original_idTipoIdentificacion) AND ((@IsNull_descripcionIdentificacion = 1 AND [descripcionIdentificacion] IS NULL) OR ([descripcionIdentificacion] = @Original_descripcionIdentificacion)) AND ((@IsNull_fechaUltimaGestion = 1 AND [fechaUltimaGestion] IS NULL) OR ([fechaUltimaGestion] = @Original_fechaUltimaGestion)) AND ((@IsNull_usuarioUltimaGestion = 1 AND [usuarioUltimaGestion] IS NULL) OR ([usuarioUltimaGestion] = @Original_usuarioUltimaGestion)))",
			...
			this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_descripcionIdentificacion", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "descripcionIdentificacion", DataRowVersion.Original, true, null, "", "", ""));
			this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_descripcionIdentificacion", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "descripcionIdentificacion", DataRowVersion.Original, false, null, "", "", ""));
			...
			{
				Connection = this.Connection,
				CommandText = "INSERT INTO [dbo].[TTipoIdentificacion] ([descripcionIdentificacion], [fechaUltimaGestion], [usuarioUltimaGestion]) VALUES (@descripcionIdentificacion, @fechaUltimaGestion, @usuarioUltimaGestion);\r\nSELECT idTipoIdentificacion, descripcionIdentificacion, fechaUltimaGestion, usuarioUltimaGestion FROM TTipoIdentificacion WHERE (idTipoIdentificacion = SCOPE_IDENTITY())",
				CommandType = CommandType.Text
			};
			this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@descripcionIdentificacion", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "descripcionIdentificacion", DataRowVersion.Current, false, null, "", "", ""));
			...
			{
				Connection = this.Connection,
				CommandText = "UPDATE [dbo].[TTipoIdentificacion] SET [descripcionIdentificacion] = @descripcionIdentificacion, [fechaUltimaGestion] = @fechaUltimaGestion, [usuarioUltimaGestion] = @usuarioUltimaGestion WHERE (([idTipoIdentificacion] = @Original_idTipoIdentificacion) AND ((@IsNull_descripcionIdentificacion = 1 AND [descripcionIdentificacion] IS NULL) OR ([descripcionIdentificacion] = @Original_descripcionIdentificacion)) AND ((@IsNull_fechaUltimaGestion = 1 AND [fechaUltimaGestion] IS NULL) OR ([fechaUltimaGestion] = @Original_fechaUltimaGestion)) AND ((@IsNull_usuarioUltimaGestion = 1 AND [usuarioUltimaGestion] IS NULL) OR ([usuarioUltimaGestion] = @Original_usuarioUltimaGestion)));\r\nSELECT idTipoIdentificacion, descripcionIdentificacion, fechaUltimaGestion, usuarioUltimaGestion FROM TTipoIdentificacion WHERE (idTipoIdentificacion = @idTipoIdentificacion)",
				CommandType = CommandType.Text
			};
			this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@descripcionIdentificacion", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "descripcionIdentificacion", DataRowVersion.Current, false, null, "", "", ""));
			...
			this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_descripcionIdentificacion", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "descripcionIdentificacion", DataRowVersion.Original, true, null, "", "", ""));
			this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_descripcionIdentificacion", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "descripcionIdentificacion", DataRowVersion.Original, false, null, "", "", ""));
			...
			this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@idTipoIdentificacion", SqlDbType.Int, 4, ParameterDirection.Input, 0, 0, "idTipoIdentificacion", DataRowVersion.Current, false, null, "", "", ""));
		}
		...
		private void InitCommandCollection()
		{
			...
			this._commandCollection[0].CommandText = "SELECT idTipoIdentificacion, descripcionIdentificacion, fechaUltimaGestion, usuarioUltimaGestion FROM dbo.TTipoIdentificacion";
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Insert(string descripcionIdentificacion, DateTime? fechaUltimaGestion, int? usuarioUltimaGestion)
		{
			int num;
			if (descripcionIdentificacion != null)
			{
				this.Adapter.InsertCommand.Parameters[0].Value = descripcionIdentificacion;
			}
			else
			{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(masterDBACDataSet.TTipoIdentificacionDataTable dataTable)
		{
		...
		{
			return this.Adapter.Update(dataSet, "TTipoIdentificacion");
		}
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(string descripcionIdentificacion, DateTime? fechaUltimaGestion, int? usuarioUltimaGestion, int Original_idTipoIdentificacion, string Original_descripcionIdentificacion, DateTime? Original_fechaUltimaGestion, int? Original_usuarioUltimaGestion, int idTipoIdentificacion)
		{
			int num;
			if (descripcionIdentificacion != null)
			{
				this.Adapter.UpdateCommand.Parameters[0].Value = descripcionIdentificacion;
			}
			else
			{
			...
			this.Adapter.UpdateCommand.Parameters[3].Value = Original_idTipoIdentificacion;
			if (Original_descripcionIdentificacion != null)
			{
				this.Adapter.UpdateCommand.Parameters[4].Value = 0;
				this.Adapter.UpdateCommand.Parameters[5].Value = Original_descripcionIdentificacion;
			}
			else
			{
			...
			this.Adapter.UpdateCommand.Parameters[10].Value = idTipoIdentificacion;
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(string descripcionIdentificacion, DateTime? fechaUltimaGestion, int? usuarioUltimaGestion, int Original_idTipoIdentificacion, string Original_descripcionIdentificacion, DateTime? Original_fechaUltimaGestion, int? Original_usuarioUltimaGestion)
		{
			int num = this.Update(descripcionIdentificacion, fechaUltimaGestion, usuarioUltimaGestion, Original_idTipoIdentificacion, Original_descripcionIdentificacion, Original_fechaUltimaGestion, Original_usuarioUltimaGestion, Original_idTipoIdentificacion);
			return num;
		}
	}
}