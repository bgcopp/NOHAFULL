...
namespace BGCOP.CAVTOP.WINFORMS.masterDBACDataSetTableAdapters
{
	...
	[ToolboxItem(true)]
	public class TEstadoTableAdapter : Component
	{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Delete(int Original_idTipoEstado, string Original_NombreEstado, DateTime? Original_fechaUltimaGestion, int? Original_usuarioUltimaGestion)
		{
			int num;
			this.Adapter.DeleteCommand.Parameters[0].Value = Original_idTipoEstado;
			if (Original_NombreEstado != null)
			{
				this.Adapter.DeleteCommand.Parameters[1].Value = 0;
				this.Adapter.DeleteCommand.Parameters[2].Value = Original_NombreEstado;
			}
			else
			{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Fill(masterDBACDataSet.TEstadoDataTable dataTable)
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual masterDBACDataSet.TEstadoDataTable GetData()
		{
			this.Adapter.SelectCommand = this.CommandCollection[0];
			masterDBACDataSet.TEstadoDataTable tEstadoDataTable = new masterDBACDataSet.TEstadoDataTable();
			this.Adapter.Fill(tEstadoDataTable);
		...
		private void InitAdapter()
		{
			...
			{
				SourceTable = "Table",
				DataSetTable = "TEstado"
			};
			dataTableMapping.ColumnMappings.Add("idTipoEstado", "idTipoEstado");
			dataTableMapping.ColumnMappings.Add("NombreEstado", "NombreEstado");
			...
			this._adapter.DeleteCommand = new SqlCommand()
			{
				...
				CommandText = "DELETE FROM [dbo].[TEstado] WHERE (([idTipoEstado] = @Original_idTipoEstado) AND ((@IsNull_NombreEstado = 1 AND [NombreEstado] IS NULL) OR ([NombreEstado] = @Original_NombreEstado)) AND ((@IsNull_fechaUltimaGestion = 1 AND [fechaUltimaGestion] IS NULL) OR ([fechaUltimaGestion] = @Original_fechaUltimaGestion)) AND ((@IsNull_usuarioUltimaGestion = 1 AND [usuarioUltimaGestion] IS NULL) OR ([usuarioUltimaGestion] = @Original_usuarioUltimaGestion)))",
			...
			this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@IsNull_NombreEstado", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "NombreEstado", DataRowVersion.Original, true, null, "", "", ""));
			this._adapter.DeleteCommand.Parameters.Add(new SqlParameter("@Original_NombreEstado", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "NombreEstado", DataRowVersion.Original, false, null, "", "", ""));
			...
			{
				Connection = this.Connection,
				CommandText = "INSERT INTO [dbo].[TEstado] ([NombreEstado], [fechaUltimaGestion], [usuarioUltimaGestion]) VALUES (@NombreEstado, @fechaUltimaGestion, @usuarioUltimaGestion);\r\nSELECT idTipoEstado, NombreEstado, fechaUltimaGestion, usuarioUltimaGestion FROM TEstado WHERE (idTipoEstado = SCOPE_IDENTITY())",
				CommandType = CommandType.Text
			};
			this._adapter.InsertCommand.Parameters.Add(new SqlParameter("@NombreEstado", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "NombreEstado", DataRowVersion.Current, false, null, "", "", ""));
			...
			{
				Connection = this.Connection,
				CommandText = "UPDATE [dbo].[TEstado] SET [NombreEstado] = @NombreEstado, [fechaUltimaGestion] = @fechaUltimaGestion, [usuarioUltimaGestion] = @usuarioUltimaGestion WHERE (([idTipoEstado] = @Original_idTipoEstado) AND ((@IsNull_NombreEstado = 1 AND [NombreEstado] IS NULL) OR ([NombreEstado] = @Original_NombreEstado)) AND ((@IsNull_fechaUltimaGestion = 1 AND [fechaUltimaGestion] IS NULL) OR ([fechaUltimaGestion] = @Original_fechaUltimaGestion)) AND ((@IsNull_usuarioUltimaGestion = 1 AND [usuarioUltimaGestion] IS NULL) OR ([usuarioUltimaGestion] = @Original_usuarioUltimaGestion)));\r\nSELECT idTipoEstado, NombreEstado, fechaUltimaGestion, usuarioUltimaGestion FROM TEstado WHERE (idTipoEstado = @idTipoEstado)",
				CommandType = CommandType.Text
			};
			this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@NombreEstado", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "NombreEstado", DataRowVersion.Current, false, null, "", "", ""));
			...
			this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@IsNull_NombreEstado", SqlDbType.Int, 0, ParameterDirection.Input, 0, 0, "NombreEstado", DataRowVersion.Original, true, null, "", "", ""));
			this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@Original_NombreEstado", SqlDbType.NVarChar, 0, ParameterDirection.Input, 0, 0, "NombreEstado", DataRowVersion.Original, false, null, "", "", ""));
			...
			this._adapter.UpdateCommand.Parameters.Add(new SqlParameter("@idTipoEstado", SqlDbType.Int, 4, ParameterDirection.Input, 0, 0, "idTipoEstado", DataRowVersion.Current, false, null, "", "", ""));
		}
		...
		private void InitCommandCollection()
		{
			...
			this._commandCollection[0].CommandText = "SELECT idTipoEstado, NombreEstado, fechaUltimaGestion, usuarioUltimaGestion FROM dbo.TEstado";
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Insert(string NombreEstado, DateTime? fechaUltimaGestion, int? usuarioUltimaGestion)
		{
			int num;
			if (NombreEstado != null)
			{
				this.Adapter.InsertCommand.Parameters[0].Value = NombreEstado;
			}
			else
			{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(masterDBACDataSet.TEstadoDataTable dataTable)
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(string NombreEstado, DateTime? fechaUltimaGestion, int? usuarioUltimaGestion, int Original_idTipoEstado, string Original_NombreEstado, DateTime? Original_fechaUltimaGestion, int? Original_usuarioUltimaGestion, int idTipoEstado)
		{
			int num;
			if (NombreEstado != null)
			{
				this.Adapter.UpdateCommand.Parameters[0].Value = NombreEstado;
			}
			else
			{
			...
			this.Adapter.UpdateCommand.Parameters[3].Value = Original_idTipoEstado;
			if (Original_NombreEstado != null)
			{
				this.Adapter.UpdateCommand.Parameters[4].Value = 0;
				this.Adapter.UpdateCommand.Parameters[5].Value = Original_NombreEstado;
			}
			else
			{
			...
			this.Adapter.UpdateCommand.Parameters[10].Value = idTipoEstado;
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(string NombreEstado, DateTime? fechaUltimaGestion, int? usuarioUltimaGestion, int Original_idTipoEstado, string Original_NombreEstado, DateTime? Original_fechaUltimaGestion, int? Original_usuarioUltimaGestion)
		{
			int num = this.Update(NombreEstado, fechaUltimaGestion, usuarioUltimaGestion, Original_idTipoEstado, Original_NombreEstado, Original_fechaUltimaGestion, Original_usuarioUltimaGestion, Original_idTipoEstado);
			return num;
		}
	}
}