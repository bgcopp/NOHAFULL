...
namespace BGCOP.CAVTOP.WINFORMS.masterDBACDataSetTableAdapters
{
	...
	[ToolboxItem(true)]
	public class viVehiculoTableAdapter : Component
	{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Fill(masterDBACDataSet.viVehiculoDataTable dataTable)
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual masterDBACDataSet.viVehiculoDataTable GetData()
		{
			this.Adapter.SelectCommand = this.CommandCollection[0];
			masterDBACDataSet.viVehiculoDataTable _viVehiculoDataTable = new masterDBACDataSet.viVehiculoDataTable();
			this.Adapter.Fill(_viVehiculoDataTable);
		...
		private void InitCommandCollection()
		{
			...
			this._commandCollection[0].CommandText = "SELECT idVehiculo, Placa, CodigodeBarras, NombreModelo, NombreMarcaVehiculo, color FROM dbo.viVehiculo";
