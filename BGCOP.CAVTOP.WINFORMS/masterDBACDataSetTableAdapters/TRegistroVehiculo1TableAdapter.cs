...
namespace BGCOP.CAVTOP.WINFORMS.masterDBACDataSetTableAdapters
{
	...
	[ToolboxItem(true)]
	public class TRegistroVehiculo1TableAdapter : Component
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		public TRegistroVehiculo1TableAdapter()
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Fill(masterDBACDataSet.TRegistroVehiculo1DataTable dataTable)
		{
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual masterDBACDataSet.TRegistroVehiculo1DataTable GetData()
		{
			this.Adapter.SelectCommand = this.CommandCollection[0];
			masterDBACDataSet.TRegistroVehiculo1DataTable tRegistroVehiculo1DataTable = new masterDBACDataSet.TRegistroVehiculo1DataTable();
			this.Adapter.Fill(tRegistroVehiculo1DataTable);
		...
		private void InitAdapter()
		{
			...
			{
				SourceTable = "Table",
				DataSetTable = "TRegistroVehiculo1"
			};
			dataTableMapping.ColumnMappings.Add("idRegistroVehiculo", "idRegistroVehiculo");
		...
		private void InitCommandCollection()
		{
			...
			this._commandCollection[0].CommandText = "SELECT idRegistroVehiculo, idVehiculo, fechadeRegistro, idPanel, idTipoRegistro, descripcionRegistro, ObservacionesRegistro, fechaUltimaGestion, usuarioUltimaGestion, idempleado, mregistro FROM dbo.TRegistroVehiculo";
		...
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
		[HelpKeyword("vs.data.TableAdapter")]
		public virtual int Update(masterDBACDataSet.TRegistroVehiculo1DataTable dataTable)
		{
		...
		{
			return this.Adapter.Update(dataSet, "TRegistroVehiculo1");
		}
